...
import com.littlelemon.ProductsWarehouse
import com.littlelemon.ProductsWarehouse.productsList
...
class MainActivity : ComponentActivity() {
    ...
    private fun startProductActivity(context: Context, productItem: ProductItem) {
        ...
        val intent = Intent(context, ProductActivity::class.java).apply {
            ...
            this.putExtra(ProductActivity.KEY_CATEGORY, productItem.category)// Resolved
        }
